...
<jsp:include page="../layout/header.jsp"></jsp:include>
	<div class="main">
		<div class="intro">
			<ul>
				<li><a href="/content?content=okay1"><button>개요</button></a></li>
				<li><a href="/content?content=okay2"><button>광고안내</button></a></li>
				<li><a href="/content?content=okay3"><button>연락처/주소</button></a></li>
			</ul>
		</div>
