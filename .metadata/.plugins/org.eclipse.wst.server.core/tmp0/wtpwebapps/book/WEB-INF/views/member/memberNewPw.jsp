...
<body>
   ...
   <div class="login-container">
      ...
      <div class="login">
         ...
         <br> <input type="text" class="join-input" name="mem_id" id="mem_id" value=${mvo.mem_id} placeholder="아이디" onchange="checkId()" required readonly="readonly"> 
         <span class="id_ok"><i class="fa-solid fa-check"></i></span> 
         <span class="id_duplicate"><i class="fa-solid fa-x"></i></span> 
         <span class="id_null"><i class="fa-solid fa-x"></i></span> <Br>
