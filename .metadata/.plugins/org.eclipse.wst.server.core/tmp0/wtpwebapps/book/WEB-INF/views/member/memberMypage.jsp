						...
						<c:choose>
							...
							<c:when test="${content eq 'delete' }">
								<div class="delete mypage-right">
									...
									<div class="long">사용하고 계신 아이디(${ses.mem_id})는 탈퇴할 경우 아이디에 대한 데이터 재사용 및 복구가 불가능합니다.
									</div>
									...
									<div class="boardRegisterBox">
										<form action="/board/register" method="post">
											...
											<div class="brd_titleAndWriter">
												...
												<input type="text" name="brd_title" class="brd_title" required>　　　
											...
											<div class="brd_content">
												...
												<textarea rows="10" cols="100" name="brd_content"></textarea><br>
											</div>
							...
							<c:when test="${content eq 'boardDetail' }">
								<div class="mypage-right boardDetail">
									...
									<a href="/board/boardModify?brd_num=${board.brd_num}">
										<button type="button" class="btn btn-success">수정</button></a>
									<a href="/board/remove?brd_num=${board.brd_num}">
