...
input#rating, input#firstRating {
	font-size: 30px;
	border: none;
	width: 25px;
}
...
<body>
	...
	<div class="event_main">
		...
		<c:if test="${ses.mem_rating eq 'D'}">
			<div id="eventBefore">
				${ses.mem_id}님은 아직 <input id="firstRating" value="${ses.mem_rating }"> 등급입니다.!!!(등급변경가능)
			</div>
			<div id="eventAfter">
				${ses.mem_id}님 <input id="rating" value="${ses.mem_rating }"> 등급입니다.!!! 축하합니다
			</div>
			<div align="center">
             ...
             let memData={
              ...
              putGrade(memData).then(result=>{
                 if(result>0){
                      ...
                      document.getElementById('eventBefore').style.display="none";
                      document.getElementById('eventAfter').style.display="inline-block";
                      document.getElementById('rating').value = mem_rating;
