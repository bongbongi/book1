	...
	<div class="login-container">
		...
		<div class="login">
			<form action="/mem/newPwUpdate" method="post">
				...
				<br> <input type="text" class="join-input" name="mem_id" id="mem_id" value=${mvo.mem_id } required readonly="readonly"> <br>
				...
				<br>
				<br> <a><button type="submit" class="btn btn-outline-secondary">확인</button></a> <br> <br>
			</form>
		</div>
	</div>
