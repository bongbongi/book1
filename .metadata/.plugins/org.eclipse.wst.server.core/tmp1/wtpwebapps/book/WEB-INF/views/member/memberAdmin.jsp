									...
									<div class="boardRegisterBox">
										<form action="/ntc/noticeRegister" method="post">
											<div class="brd_titleAndWriter">
												<input type="hidden" name="ntc_mem_num" value="${ses.mem_num }"> <label for="ntc_title">제목</label> <input type="text" name="ntc_title" class="ntc_title" required> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <label for="ntc_title">작성자</label> <input type="text" name="ntc_writer" value="${ses.mem_id}" readonly><br>
											</div>
								...
								<c:when test="${content eq 'faqModify' }">
									...
									<div class="boardRegisterBox">
										<form action="/faq/faqModify?faq_num=${fo.faq_num }" method="post">
											...
											<div class="contentBox">
												<label for="faq_answer" class="contentLabel">답변</label><br>
												<textarea rows="10" cols="100" name="faq_answer">${fo.faq_answer }</textarea>
												<br>
											</div>
