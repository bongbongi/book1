...
<body>
	...
	<div class="intro">
		<a href="/content?content=okay1"><button>개요</button></a> <a href="/content?content=okay2"><button>광고안내</button></a> <a href="/content?content=okay3"><button>연락처/주소</button></a>
	</div>
	<div class="main">
			...
			<c:choose>
				<c:when test="${content eq	'okay1' || content == 'main'}">
					<div class="companyIntroduce">
						<img alt="로고" src="/resources/img/logo.jpg"><Br> 'ww'는 when where 의 약자로서 언제든 어디서든 노력한다는 뜻입니다.<br> 'ww'라는 브랜드에는 고객의 꿈을 위해 언제, 어디서든 노력한다는 기업정신이 담겨 있습니다. <br> 'ww'는 수 없이 많은 새로운 서비스를 전자상거래에 도입하였으며 우리가 도입하면 그것이 곧 업계의 표준이 되었습니다. <br>오늘도 'WW'는 혁신을 거듭하며 우리나라 전자상거래의 역사를 새롭게 써나가고 있습니다.<br>
						<div class="tableBox">
