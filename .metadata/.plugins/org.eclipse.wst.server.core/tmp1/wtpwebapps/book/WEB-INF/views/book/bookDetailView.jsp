...
<body>
	...
	<div class="bookDetail">
		...
		<div class="detailViewBox">
			...
			<div class="seoji">
				...
				<div class="qty">
					...
					<div class="arrow">
						<img onclick='count("plus")' src="/resources/img/upArrow.png" class="upArrow" alt="upArrow" style="width: 35px"> <img onclick='count("minus")' src="/resources/img/downArrow.png" class="downArrow" alt="downArrow" style="width: 35px"><br> <br>
					</div>
				</div>

				<input type="hidden" id="mem_num" value="${ses.mem_num}"> <input type="hidden" id="book_num" value="${bvo.book_num}">
				<div class="btnBox">
					<!-- 로그인이 되었을때 -->
					...
					<c:if test="${ses.mem_id == null}">
						<button type="button" class="btn btn-secondary">
							<a href="/mem/loginPage" onclick="gologin(event)" style="color: white;">장바구니</a>
						</button>
					</c:if>
		...
		<input type="hidden" id="book_inventory" value="${bvo.book_count}"> <br>
		...
		<div class="review">
			<form class="mb-3" name="myform" id="myform" method="post">
				...
				<div class="reviewBox">
					...
					<br> <span>${review_mem_id }</span> <span class="btnBox">
