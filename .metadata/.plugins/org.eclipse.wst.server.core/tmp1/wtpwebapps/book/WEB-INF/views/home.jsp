						...
						<ul class="BestSellerList">
							<c:forEach items="${book_list}" var="list" varStatus="i" begin="0" end="9">
								<li class="Best_item">
									...
									<div class="img_box">
										<a href="/book/bkDetailView?book_num=${list.bvo.book_num}"> <img class="book_img" src="/upload/${fn:replace(list.save_dir,'\\','/')}/${list.uuid}_${list.file_name}" alt="bookThumbnail">
										</a>
									</div>
									<div class="info_box">
										<span class="main_book_header ellipsis-two">${list.bvo.book_title}</span> <span class="main_book_writer">${list.bvo.book_writer} : ${list.bvo.book_publisher}</span>
									</div>
								</li>
							</c:forEach>
						</ul>
