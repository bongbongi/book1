	...
	<div class="wrapper">
		<div class="wrap">
			...
			<div class="content_area">
					...
					<table class="cart_table">
						...
						<tbody>
							<c:forEach items="${Clist}" var="cvo">
								<tr>
									<td class="td_width_1 cart_info_td"><input type="checkbox" class="individual_cart_checkbox input_size_20" checked="checked"> <input type="hidden" class="bookPrice_input" value="${cvo.cart_price}"> <input type="hidden" class="salePrice_input" value="${cvo.cart_price}"> <input type="hidden" class="bookCount_input" value="${cvo.cart_amount}"> <input type="hidden" class="totalPrice_input" value="${cvo.cart_price * cvo.cart_amount}"> <input type="hidden" class="point_input" value="${(cvo.cart_price*0.5)}"> <input type="hidden" class="totalPoint_input" value="${(cvo.cart_price*0.05)*cvo.cart_amount}"> <input type="hidden" class="bookId_input" value="${cvo.cart_book_num}"></td>
									<td>
										<div class="td_width_2">
											<a href="/book/bkDetailView?book_num=${cvo.cart_book_num}"> <img class="book_img" src="/upload/${fn:replace(cvo.imageList[0].save_dir,'\\','/')}/${cvo.imageList[0].uuid}_${cvo.imageList[0].file_name}" style="height: 80px; width: 70px;" alt="bookThumbnail">
											</a>
										</div>
									</td>
									<td class="td_width_3">${cvo.cart_book_name}</td>
									<td class="td_width_4 price_td" style="text-align: center;"><fmt:formatNumber value="${cvo.cart_price}" pattern="#,### 원" /><br></td>
									...
									<td class="td_width_4 table_text_align_center"><fmt:formatNumber value="${cvo.cart_price * cvo.cart_amount}" pattern="#,### 원" /></td>
									<td class="td_width_4 table_text_align_center">
							...
							<tr>
								<td>
									<table>
										...
										<tr>
											<td>배송비</td>
											<td><span class="delivery_price">2500</span>원</td>
										</tr>
										<tr>
											<td>총 주문 상품수</td>
				...
				<!-- 주문 form -->
				<form action="/order/order1/${mvo.mem_num}" method="get" class="order_form"></form>
